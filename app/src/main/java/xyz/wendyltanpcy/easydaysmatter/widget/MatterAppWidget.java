...
public class MatterAppWidget extends AppWidgetProvider {
    ...
    public static final String ACTION_DONE = "xyz.wendyltanpcy.easydaysmatter.widget.ACTION_DONE";
    public static final String EXTRA_DO = "xyz.wendyltanpcy.easydaysmatter.widget.EXTRA_DO";
    ...
    private RemoteViews initView(Context context, AppWidgetManager widgetManager, int appWidgetId){
        RemoteViews mViews = new RemoteViews(context.getPackageName(), R.layout.matter_app_widget);
